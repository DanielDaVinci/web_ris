...
def query_light_2():
    if request.method == 'GET':
        return render_template('query/query_light_2.html',
                               wrong=False, max_date=datetime.now().date())
    else:
        ...
        if flights:
            ...
            return render_template('query/query_light_2.html',
                                   wrong=True, max_date=datetime.now().date())
...
def query_hard_1():
    if request.method == 'GET':
        return render_template('query/query_hard_1.html',
                               wrong=False, max_date=datetime.now().date())
    else:
        date = request.form.get('date')
...
def query_hard_3():
    if request.method == 'GET':
        return render_template('query/query_hard_3.html',
                               wrong=False, max_date=datetime.now().date())
    else:
        flight_id_name = request.form.get('flight_id_name')
        date = request.form.get('date')
